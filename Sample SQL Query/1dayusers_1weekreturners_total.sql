SELECT A.id, 
SUM(CASE WHEN eventname LIKE '%Message%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS totalmessages, 
A.createddate, A.sex,  
SUM(CASE WHEN (eventname LIKE 'Dater - Match' or eventname LIKE 'Dater - Match - v2') AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS matches, 
SUM(CASE WHEN eventname LIKE '%User photo t%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS photoview,
SUM(CASE WHEN eventname LIKE '%View P%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS viewprofile,
SUM(CASE WHEN eventname LIKE '%No recommendation%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS norec,
SUM(CASE WHEN eventname LIKE '%Icebreaker%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS icebreaker,
SUM(CASE WHEN eventname LIKE '%Add ph%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS addphoto,
SUM(CASE WHEN eventname LIKE '%topic ans%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS topicansw,
SUM(CASE WHEN eventname LIKE '%Recommendation ans%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS recansw,
SUM(CASE WHEN eventname LIKE '%Datemode v%' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
THEN 1 ELSE 0 END) AS visits,
SUM(CASE WHEN eventname LIKE '%_start' AND eventdate BETWEEN A.createddate AND DATEADD(day, 1 , A.createddate)
